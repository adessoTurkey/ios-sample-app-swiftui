...
struct PriceChartView: View {
    ...
    private var chart: some View {
        Chart(viewModel.coinPrices) {
            ...
            .foregroundStyle(
                LinearGradient(
                    gradient: Gradient(colors: [viewModel.dataModel?.lineColor ?? .black, .clear]),
                    startPoint: .top,
                    endPoint: .bottom
                )
            )
    ...
    static let demo = CoinPriceHistoryChartDataModel(
        from: CoinPriceHistoryDataUIModel(
            ...
            data: [
                ...
                CoinPriceInfoUIModel(time: 1685059200, high: -3.592, low: 3.544, open: 4.562, volumeFrom: 15886.3, volumeTo: 56872.31, close: 3.563),
                ...
                CoinPriceInfoUIModel(time: 1685693085, high: 7.592, low: 0.544, open: 4.562, volumeFrom: 15886.3, volumeTo: 56872.31, close: 3.563),
